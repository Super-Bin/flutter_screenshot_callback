...
public class ScreenshotCallbackPlugin implements FlutterPlugin, MethodCallHandler,ActivityAware, ScreenShotListenManager.OnScreenShotListener {
  ...
  public void onAttachedToEngine(@NonNull FlutterPluginBinding flutterPluginBinding) {
    ...
    Log.i("zzb", "onAttachedToEngine");
//    mScreenShotListenManager = new ScreenShotListenManager(flutterPluginBinding);
  }
  ...
  public void onMethodCall(@NonNull MethodCall call, @NonNull Result result) {
    ...
    Log.i("zzb", "截图方法onMethodCall call.method =  " + call.method);
    switch (call.method) {
  ...
  public void onAttachedToActivity(@NonNull ActivityPluginBinding binding) {
    Log.i("zzb", "onAttachedToActivity");
